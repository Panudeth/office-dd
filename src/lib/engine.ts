...
${customer
    ? `ถ้าข้อมูลที่ให้ไว้ไม่มีเรื่องที่ลูกค้าถาม: ขอโทษสั้น ๆ ว่าตอนนี้ยังไม่มีข้อมูลเรื่องนี้ แล้วเสนอสิ่งที่ช่วยได้จากข้อมูลที่มี หรือช่องทางติดต่อ (ถ้ามีในข้อมูล)
ห้ามพูดถึงระบบหลังบ้าน ห้ามแนะนำให้ "กรอก/เพิ่มข้อมูล" ห้ามพูดว่า "ในเอกสาร/ในข้อมูลที่ให้มา" - ลูกค้าไม่รู้จักและไม่ควรรู้ว่าคุณอ่านอะไรอยู่
