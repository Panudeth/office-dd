...
export default function IntegrationsPanel({ open, onClose, office }: { open: boolean; onClose: () => void; office: Office | null }) {
  return (
    <Dialog open={open} onOpenChange={(v) => !v && onClose()}>
      <DialogContent
        ...
        wide
      >
        {office ? <IntegrationsSection office={office} /> : null}
      </DialogContent>
    </Dialog>
  );
}
